SELECT 
    ...
    SUM(CASE WHEN 연도 = 2023 THEN 물동량 ELSE 0 END) AS 2023년_물동량,
    -- Calculate the volume difference between 2023 and 2022
    SUM(CASE WHEN 연도 = 2023 THEN 물동량 ELSE 0 END) - SUM(CASE WHEN 연도 = 2022 THEN 물동량 ELSE 0 END) AS 물동량_변화량
FROM 
